...
(() => {
  ...
  // src/acc.ts
  var Account = class {
    async account(func, username, userdata) {
      let gameRequest = {
        function: func,
        username,
        Userdata: userdata
